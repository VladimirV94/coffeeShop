...
public class MainMenuInterface extends AbstacratInterface {
	...
	public int show()
	{
		...
		//XXX Вместо while и getSelectedCommandId() можно реализовать через слушателя команд. 
		...
		// чтобы неактивные интефейсы не реагировали на комманды, которые не предназначены им.
		// Либо необходимо оборачивать каждый интерфейс статусом активный/не активный и скипать любые команды, если он не активен
